    ...
    plugins: [
      new ModuleFederationPlugin({
        ...
        shared: {
          ...
          '@angular/core': { singleton: true, strictVersion: true, requiredVersion: '16.0.5' },
          '@angular/common': { singleton: true, strictVersion: true, requiredVersion: '16.0.5' },
          '@angular/common/http': { singleton: true, strictVersion: true, requiredVersion: '16.0.5' },
          '@angular/router': { singleton: true, strictVersion: true, requiredVersion: '16.0.5' },
          '@angular/forms': { singleton: true, strictVersion: true, requiredVersion: '16.0.5' },
          '@angular/platform-browser': { singleton: true, strictVersion: true, requiredVersion: '16.0.5' },
          ...
          '@ng-bootstrap/ng-bootstrap': { singleton: true, strictVersion: true, requiredVersion: '15.0.1' },
          ...
          dayjs: { singleton: true, strictVersion: true, requiredVersion: '1.11.8' },
          ...
          'zone.js': { singleton: true, strictVersion: true, requiredVersion: '0.13.0' },
